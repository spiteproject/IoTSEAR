...
@Extension
public class FreshnessVerifier1s extends FreshnessVerifier implements PolicyConditionVerifierFactory {
    @Override
    ...
    public String getProviderID() {
        return "darc:condition:verifier:freshness:1s";
    }

    @Override
    public PolicyConditionVerifier createPolicyConditionVerifier() {
        return new FreshnessVerifier1s();
    }
}
