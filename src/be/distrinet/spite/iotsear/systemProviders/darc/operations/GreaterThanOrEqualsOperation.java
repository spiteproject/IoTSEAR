...
@Extension
public class GreaterThanOrEqualsOperation extends PolicyConditionOperation implements PolicyConditionOperationFactory {
    @Override
    public PolicyConditionOperation createPolicyConditionOperation(final Map<String, String> arguments) {
        return new GreaterThanOrEqualsOperation();
    }

    @Override
    public String getProviderID() {
        return "darc:condition:operation:geq";
    }
