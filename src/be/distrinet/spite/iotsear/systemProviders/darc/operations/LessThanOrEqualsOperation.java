...
@Extension
public class LessThanOrEqualsOperation extends PolicyConditionOperation implements PolicyConditionOperationFactory {
    @Override
    public PolicyConditionOperation createPolicyConditionOperation(final Map<String, String> arguments) {
        return new LessThanOrEqualsOperation();
    }

    @Override
    public String getProviderID() {
        return "darc:condition:operation:leq";
    }
